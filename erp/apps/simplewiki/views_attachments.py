...
from erp.apps.simplewiki.models import Article, ArticleAttachment, get_attachment_filepath
from erp.apps.simplewiki.views import not_found, check_permissions, get_url_path, fetch_from_url

@transaction.commit_on_success
def add_attachment(request, wiki_url):

    (article, err) = fetch_from_url(request, wiki_url)
    if err:
        return err
