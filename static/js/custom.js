...
================================================== */
	...
	$( ".datepickerInline" ).livequery(function() {
        $(this).datepicker({
            defaultDate: +7,
            autoSize: true,
            //appendText: '(dd-mm-yyyy)',
...
================================================== */
	...
	$.fn.contentTabs = function(){ 
		...
		$("ul.tabs li").click(function() {
            ...
            try {
                $('*').colorbox.resize();
            } catch(e) {} //In case tabs are used insisde colorbox, try to resize it

			return false;
		});
	
	};
	$("div[class^='widget']").livequery(function(){
        $(this).contentTabs(); //Run function on any div with class name of "Content Tabs"
    })
